...
DR_EXPLAIN.data_menu = {
	// menu
	DREX_NODE_NAMES: ["CourseWork_2016","Работа с программой","Системные требования","About","Разработчик","Заполнение данных","Работа и сохранение"],
	DREX_NODE_LINKS: ["coursework_2016.htm","rabota_s_programmoj.htm","sistemnye_trebovaniya.htm","about.htm","razrabotchik.htm","zapolnenie_dannykh.htm","rabota_i_sokhranenie.htm"],
	DREX_NODE_CHILD_START: [1,5,7,7,7,7,7],
	DREX_NODE_CHILD_END: [5,7,7,7,7,7,7],
	DREX_MENU_TYPE: 1,
